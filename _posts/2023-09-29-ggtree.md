...
**The datasets used for this tutorial are found in my  [ggtree repo](https://github.com/amycjack/ggtree_scripts), which were generated for my [paper](https://bsapubs.onlinelibrary.wiley.com/doi/full/10.1002/ajb2.16162) on Canary Island _Descurainia_.**

![This is an image](/images/plot03102023.png)
*A phylogeny generated using the following script*

## Loading packages and tree file
